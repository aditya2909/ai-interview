  ...
  try {
    ...
    const messages = [
      {
        ...
        Speak in simple, natural English as if you are directly talking to candidate.
        ...
        Make questions based on candidate's role, experience, interviewMode, projects, skiils, and resume details.
        `,
      },
      {
        role: "user",
    ...
    const interview = await Interview.create({
      ...
      questions: questionsArray.map((q, index) => ({
        question: q,
        difficuty: ["easy", "easy", "medium", "medium", "hard"][index],
    ...
    const messages = [
      {
        ...
        Calculate: 
        finalScore = average of confidence, communication, and correctness (round to nearest whole number).
