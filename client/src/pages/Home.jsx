      ...
      <div className="flex-1 px-6 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-center mb-6">
            <div className="bg-gray-100 text-gray-600 text-sm pc-4 py-2 rounded-full flex items-center gap-2">
              <HiSparkles
                size={16}
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-10 mb-28">
            {[
              ...
              <motion.div
                ...
                className={`relative bg-white rounded-3xl border-2 border-green-100 hover:border-green-500 p-10 w-80 max-w-[90%] shadow-md hover:shadow-2xl transition-all duration-300 ${index === 0 ? "rotate-[-4deg]" : ""} ${index === 1 ? "rotate-3 md:-mt-6 shadow-xl" : ""} ${index === 2 ? "-rotate-3" : ""}`}
              >
                <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-white border-2 border-green-500 w-16 h-16 rounded-2xl flex items-center justify-center text-green-600 shadow-lg">
                  {item.icon}
                </div>
                <div className="pt-10 text-center">
                  <div className="text-xs text-green-600 tracking-wider mb-2 font-semibold">
                    {item.step}
                  </div>
