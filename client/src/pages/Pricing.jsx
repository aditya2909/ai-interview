    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-emerald-50 py-16 px-6">
      <div className="max-w-6xl mx-auto mb-14 flex items-start gap-4">
        ...
        <div className="text-center w-full">
          <h1 className="text-4xl font-bold text-gray-600">Choose Your Plan</h1>
        ...
        {plans.map((plan) => {
          ...
          return (
            ...
            >
              ...
              {/* Default Tag */}
              {plan.default && (
                <div className="absolute top-6 right-6 bg-gray-200 text-gray-700 text-xs px-4 py-1 rounded-full shadow">
                  Default
                </div>
              )}
