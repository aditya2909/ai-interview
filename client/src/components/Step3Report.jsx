...
function Step3Report({ report }) {
  ...
  if (finalScore >= 8) {
    ...
    shortTagline = "Excellant clarity and structured responses.";
  ...
  const downloadPdf = () => {
    ...
    if (finalScore >= 8) {
      ...
      advice =
        "Significant improvement required. Focus on structured thinking clarity, and confident delivery. Practise answering aloud regularly.";
    }
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8">
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          onClick={downloadPdf}
          className="bg-emerald-600 hover:bg-emerald-700 text-white px-1 py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap"
        >
          Download PDF
        </button>
      </div>
