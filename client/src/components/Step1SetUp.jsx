...
import { FaBriefcase, FaChartLine, FaUserTie } from "react-icons/fa6";
import { FaFileUpload, FaMicrophoneAlt } from "react-icons/fa";
      ...
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        ...
        >
          ...
          <p className="text-gray-600 mb-10">
            Practise real interview scenarios powered by AI. Improve
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.03 }}
              whileTap={{ scale: 0.95 }}
              className="w-full disabled:bg-gray-100 bg-green-600 hover:bg-green-700 text-white py-3 ounded-full text-lg font-semibold transition duration-300 shadow-md"
            >
